...
/// <summary>
/// The <c>Against</c> class provides utility methods for preventing violations to preconditions over function arguments.
/// </summary>
public static class Against
{
    /// <summary>
    /// Verifies that the specified <paramref name="type"/> is assignable to the specified <paramref name="target"/>
    /// <see cref="Type"/>.
    /// </summary>
    /// <param name="type">The <see cref="Type"/> to validate.</param>
    /// <param name="target">The <see cref="Type"/> from which the one specified must derive.</param>
    /// <param name="name">The identifier for the parameter being validated.</param>
    /// <returns>The specified <paramref name="type"/> if it is assignable to the specified <paramref name="target"/>
    /// <see cref="Type"/>.</returns>
    /// <exception cref="ArgumentException">If the specified <paramref name="type"/> is not assignable to the specified
    ...
    /// <summary>
    /// Verifies that the specified <paramref name="type"/> is assignable to <typeparamref name="TTarget"/>.
    /// </summary>
    /// <typeparam name="TTarget">The <see cref="Type"/> from which the one specified must derive.</typeparam>
    /// <param name="type">The <see cref="Type"/> to validate.</param>
    /// <param name="name">The identifier for the parameter being validated.</param>
    /// <returns>The specified <paramref name="type"/> if it is assignable to <typeparamref name="TTarget"/>.</returns>
    /// <exception cref="ArgumentException">If the specified <paramref name="type"/> is not assignable to <typeparamref
    /// name="TTarget"/>.</exception>
    ...
    /// <summary>
    /// Verifies that the specified <see cref="string"/>, <paramref name="s"/>, is not <c>null</c>, the empty string, or
    /// composed solely of whitespace characters.
    /// </summary>
    /// <param name="s">The <see cref="string"/> to validate</param>
    /// <param name="name">The identifier for the parameter being validated.</param>
    /// <returns><paramref name="s"/> if it is neither <c>null</c>, empty, nor composed solely of whitespace
    /// characters.</returns>
    /// <exception cref="ArgumentException">If <paramref name="s"/> is either <c>null</c>, empty, or composed solely of
    ...
    /// <summary>
    /// Verifies that the specified <see cref="int"/>, <paramref name="i"/>, is greater than or equal to zero.
    /// </summary>
    /// <param name="i">The <see cref="int"/> to validate.</param>
    /// <param name="name">The identifier for the parameter being validated.</param>
    /// <returns><paramref name="i"/> if it is greater than or equal to zero.</returns>
    ...
    /// <summary>
    /// Verifies that the specified <see cref="Nullable{T}"/> <see cref="int"/>, <paramref name="i"/>, is greater than or
    /// equal to zero or <c>null</c>.
    /// </summary>
    /// <param name="i">The <see cref="Nullable{T}"/> <see cref="int"/> to validate.</param>
    /// <param name="name">The identifier for the parameter being validated.</param>
    /// <returns><paramref name="i"/> if it is greater than or equal to zero or <c>null</c>.</returns>
    /// <exception cref="ArgumentException">If <paramref name="i"/> is less than zero.</exception>
    public static int? Negative(int? i, string? name = null)
    {
    ...
    /// <exception cref="ArgumentOutOfRangeException">If <paramref name="i"/> is less than <paramref name="min"/> or
    ...
    /// <param name="max">The highest value that <paramref name="i"/> may hold.</param>
    /// <param name="name">The identifier for the parameter being validated.</param>
    /// <returns><paramref name="i"/> if it is on the defined interval, or if it is <c>null</c>.</returns>
    /// <exception cref="ArgumentOutOfRangeException">If <paramref name="i"/> is less than <paramref name="min"/> or
    /// greater than <paramref name="max"/>.</exception>
    public static int? OutOfRange(int? i, int min, int max, string? name = null)
    {
    ...
    /// <summary>
    /// Verifies that the specified <see cref="double"/>, <paramref name="d"/>, is greater than or equal to zero.
    /// </summary>
    /// <param name="d">The <see cref="double"/> to validate.</param>
    /// <param name="name">The identifier for the parameter being validated.</param>
    /// <returns><paramref name="d"/> if it is greater than or equal to zero.</returns>
    ...
    /// <summary>
    /// Verifies that the specified <see cref="Nullable{T}"/> <see cref="double"/>, <paramref name="d"/>, is greater than
    /// or equal to zero or <c>null</c>.
    /// </summary>
    /// <param name="d">The <see cref="Nullable{Double}"/> to validate.</param>
    /// <param name="name">The identifier for the parameter being validated.</param>
    /// <returns><paramref name="d"/> if it is greater than or equal to zero or <c>null</c>.</returns>
    /// <exception cref="ArgumentException">If <paramref name="d"/> is less than zero.</exception>
    public static double? Negative(double? d, string? name = null)
    {
    ...
    /// <summary>
    /// Verifies that the specified <see cref="double"/>, <paramref name="d"/>, is on the continuous, inclusive interval
    /// bounded by the specified <paramref name="min"/> and <paramref name="max"/> values.
    /// </summary>
    /// <param name="d">The <see cref="double"/> to validate.</param>
    ...
    /// <exception cref="ArgumentOutOfRangeException">If <paramref name="d"/> is less than <paramref name="min"/> or
    /// greater than <paramref name="max"/>.</exception>
    ...
    /// <summary>
    /// Verifies that the specified <see cref="Nullable{T}"/> <see cref="double"/>, <paramref name="d"/>, is on the
    /// continuous, inclusive interval bounded by the specified <paramref name="min"/> and <paramref name="max"/> values.
    /// </summary>
    /// <param name="d">The <see cref="Nullable{T}"/> <see cref="double"/> to validate.</param>
    /// <param name="min">The lowest value that <paramref name="d"/> may hold.</param>
    /// <param name="max">The highest value that <paramref name="d"/> may hold.</param>
    /// <param name="name">The identifier for the parameter being validated.</param>
    /// <returns><paramref name="d"/> if it is on the defined interval, or if it is <c>null</c>.</returns>
    /// <exception cref="ArgumentOutOfRangeException">If <paramref name="d"/> is less than <paramref name="min"/> or
    /// greater than <paramref name="max"/>.</exception>
    public static double? OutOfRange(double? d, double min, double max, string? name = null)
    {
    ...
    /// <summary>
    /// Verifies that the specified element from <typeparamref name="T"/>, <paramref name="t"/>, is greater than or
    /// equal to the specified <paramref name="min"/> element.
    /// </summary>
    ...
    /// <param name="min">The element from <typeparamref name="T"/> to validate <paramref name="t"/>
    /// against.</param>
    /// <param name="name">The identifier for the parameter being validated.</param>
    /// <returns><paramref name="t"/> if it is greater than or equal to the specified <paramref name="min"/>.</returns>
    /// <exception cref="ArgumentException">If <paramref name="t"/> is less than the specified <paramref
    /// name="min"/>.</exception>
    ...
    /// <summary>
    /// Verifies that the specified element from <typeparamref name="T"/>, <paramref name="t"/>, is less than or
    /// equal to the specified <paramref name="max"/> element.
    /// </summary>
    /// <typeparam name="T">The <see cref="Type"/> of argument being validated.</typeparam>
    /// <param name="t">The element from <typeparamref name="T"/> to validate.</param>
    /// <param name="max">The element from <typeparamref name="T"/> to validate <paramref name="t"/>
    /// against.</param>
    /// <param name="name">The identifier for the parameter being validated.</param>
    /// <returns><paramref name="t"/> if it is less than or equal to the specified <paramref name="max"/>.</returns>
    /// <exception cref="ArgumentException">If <paramref name="t"/> is greater than the specified <paramref
    /// name="max"/>.</exception>
    ...
    /// fails.</param>
    /// <param name="name">The identifier for the parameter being validated.</param>
    /// <returns>The specified element from <typeparamref name="T"/>, <paramref name="t"/>, if it satisfies the specified
    /// <paramref name="precondition"/>.</returns>
    /// <exception cref="ArgumentException">If the specified element from <typeparamref name="T"/>, <paramref name="t"/>,
    ...
    /// specified <paramref name="enumerable"/> are caught and ignored.</param>
    /// <param name="name">The identifier for the parameter being validated.</param>
    /// <returns>A new <see cref="EnumerableValidator{T}"/>.</returns>
    public static EnumerableValidator<T> InvalidEnumerable<T>(IEnumerable<T> enumerable, bool suppressExceptions = false, string? name = null)
    {
